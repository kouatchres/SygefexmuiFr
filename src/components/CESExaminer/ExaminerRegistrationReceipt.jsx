...
const ExaminerRegistrationReceipt = ({ id }) => {
  ...
  const { examiner, centerExamSession, phaseRank } = {
    ...state.centerExamSessionExaminer,
  };
  ...
  return (
    <Formik initialValues={initialValues}>
      {({ isSubmitting, values }) => (
        <MiniStyledPage>
          <h4>
            Confirmation de poste de l'Examinateur: {examiner1stName}{" "}
            {examiner2ndName} {examinerOtherNames}
          </h4>
            ...
            <Form>
              <SchoolInfoBlock>
                <SchoolInfo>
                  ...
                  <span>
                    <strong> Noms: </strong> {examiner1stName} {examiner2ndName}{" "}
                    {examinerOtherNames}
                  </span>
                  <span>

...
const suspects =scores && scores.map((item)=>({
  id:item.subjectSpecialty.id,
  subjectAve:item.subjectAve,
  coeff:item.coeff,
  ...item.subjectSpecialty.subject,
}))

const sortedSuspects= suspects && suspects.sort(compareValues("subjectName"))

console.log({sortedSuspects})

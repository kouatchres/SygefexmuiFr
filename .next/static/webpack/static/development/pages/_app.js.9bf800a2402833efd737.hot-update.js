...
var ToolBarNavItem = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "MegaMenu__ToolBarNavItem",
  componentId: "sc-1gy0ucv-0"
})(["*{box-sizing:border-box;}max-width:100vw;height:0.9rem;margin:0 auto;}*/ body{font-family:'Roboto Slab','Open Sans','Segoe UI','Helvetica Neue',Helvetica,Arial,sans-serif;margin:0;padding:0;}nav{background:black;margin:0;padding:0 2rem;height:3.5rem;align-items:center;width:100vw;color:white}nav ul{list-style:none;position:relative;margin:0;padding:0;}nav li{display:inline-block;}nav a{text-decoration:none;display:block;color:white;padding:0  0.5rem;:hover{color:", ";}}nav li:hover{border-top-right-radius:0.8rem;border-top-left-radius:0.8rem;background:white;color:black;}.menu-main{padding-top:1rem;height:3.5rem;font-size:1.6rem;}.menu-main a{padding:0 0.5rem;}.menu-sub{width:100 %;position:absolute;background:white;color:black;display:none;padding:1rem;border-bottom-right-radius:0.8rem;border-bottom-left-radius:0.8rem;}nav li:hover .menu-sub{display:block;}.menu-sub li{display:block;}.menu-sub a{margin:0;padding:0;font-size:1.2rem;color:black;}.menu-sub a:hover{text-decoration:underline;}.menu-sub-user{width:70 %;position:absolute;background:black;color:white;display:none;padding:1rem;border-bottom-right-radius:0.8rem;border-bottom-left-radius:0.8rem;}nav li:hover .menu-sub-user{display:block;}.menu-sub-user li{display:block;}.menu-sub-user a{margin:0;padding:0;font-size:1.2rem;color:white;}.menu-sub-user a:hover{text-decoration:underline;}.menu-category{font-size:1rem;margin-top:0;color:black;margin-bottom:0.5rem;text-align:left;text-transform:uppercase;}.menu-category:first-of-type{margin-top:0;margin-bottom:0;}.menu-col-1,.menu-col-2,.menu-col-3,.menu-col-4{float:left;}.menu-col-1,.menu-col-2,.menu-col-3,.menu-col-4{width:25 %;padding:1rem;border-right:1px solid #fff;}.menu-category:last-of-type{border-right:none;}hr{margin:0;padding:0;}@media(max-width:650){body{}nav{position:absolute;right:0;height:90vh;top:3.5rem;background:black;display:flex;flex-direction:column;align-items:center;width:50% transform:translateX(100%);transistion:transform 0.5s ease-in;}nav li{display:block;}}"], function (props) {
...
var MegaMenu = function MegaMenu() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ToolBarNavItem, {
    ...
    __self: this
  }, "S'enregistrer"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 197
    },
    ...
    __self: this
  }, "Ouverture de compte")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 201
    },
...
//# sourceMappingURL=_app.js.9bf800a2402833efd737.hot-update.js.map